...
ownerNumber = ["60199782326:60199782326@s.whatsapp.net","0@s.whatsapp.net"] //ubah jadi nomor lu.
...
if (new Date() * 1 - settingstatus > 1000) {
  ...
  await conn.setStatus(`Selfbot by Adii : ${uptime}`).catch((_) => _);
...
case 'd':
				...
				case 'delete':
					...
					break                     
case'sc':
reply('Bot ini menggunakan sc https://github.com/Adiixyz/SelfBotDy')
break
